...
public class UserRegistration {
   ...
   * Gets or Sets rol
   */
  @JsonAdapter(RolEnum.Adapter.class)
  public enum RolEnum {
    USER("user"),
    ...
    public static class Adapter extends TypeAdapter<RolEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final RolEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public RolEnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
        return RolEnum.fromValue(value);
      }
    }

    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      String value = jsonElement.getAsString();
      RolEnum.fromValue(value);
    }
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("rol") != null && !jsonObj.get("rol").isJsonNull()) {
        RolEnum.validateJsonElement(jsonObj.get("rol"));
      }
  }
